...
models_list[[3]] <- brm(
  ...
  save_model = here(
    ...
    "DAG",
    "brm_models",
    "Atoll_TD_2_pisc-SLS_model.stan"
  ),
  save_pars = save_pars(all = TRUE) # Needed for reloo
)
...
models_list[[7]] <- brm(
  ...
  save_model = here(
    ...
    "DAG",
    "brm_models",
    "Atoll_TD_5_plank-RS_model.stan"
  ),
  save_pars = save_pars(all = TRUE) # Needed for reloo
)
...
models_list[[8]] <- brm(
  ...
  save_model = here(
    ...
    "DAG",
    "brm_models",
    "Atoll_TD_6_herb-pisc_model.stan"
  ),
  save_pars = save_pars(all = TRUE) # Needed for reloo
)
...
models_list[[9]] <- brm(
  ...
  save_model = here(
    ...
    "DAG",
    "brm_models",
    "Atoll_TD_7_plank-pisc_model.stan"
  ),
  save_pars = save_pars(all = TRUE) # Needed for reloo
)
...
models_list[[10]] <- brm(
  ...
  save_model = here(
    ...
    "DAG",
    "brm_models",
    "Atoll_TD_8_inv-pisc_model.stan"
  ),
  save_pars = save_pars(all = TRUE) # Needed for reloo
)
...
models_list[[12]] <- brm(
  ...
  save_model = here(
    ...
    "DAG",
    "brm_models",
    "Atoll_TD_10_CCA-herb_model.stan"
  ),
  save_pars = save_pars(all = TRUE) # Needed for reloo
)
...
models_list[[13]] <- brm(
  ...
  save_model = here(
    ...
    "DAG",
    "brm_models",
    "Atoll_TD_11_OA-herb_model.stan"
  ),
  save_pars = save_pars(all = TRUE) # Needed for reloo
)
...
dfTDatoll$label <- factor(dfTDatoll$label, levels = rev(dfTDatoll$label))
...
TDatollplot <- ggplot(dfTDatoll, aes(x = effect, y = label, color = group)) +
  geom_point(size = 3) +
