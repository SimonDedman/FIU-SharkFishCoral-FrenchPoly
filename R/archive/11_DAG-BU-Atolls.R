...
models_list[[3]] <- brm(
  ...
  save_model = here(
    ...
    "DAG",
    "brm_models",
    "Atoll_BU_2_SLS-pisc_model.stan"
  ),
  save_pars = save_pars(all = TRUE) # Needed for reloo
)
...
models_list[[7]] <- brm(
  ...
  save_model = here(
    ...
    "DAG",
    "brm_models",
    "Atoll_BU_5_RS-plank_model.stan"
  ),
  save_pars = save_pars(all = TRUE) # Needed for reloo
)
...
models_list[[8]] <- brm(
  ...
  save_model = here(
    ...
    "DAG",
    "brm_models",
    "Atoll_BU_6_pisc-herb_model.stan"
  ),
  save_pars = save_pars(all = TRUE) # Needed for reloo
)
...
models_list[[9]] <- brm(
  ...
  save_model = here(
    ...
    "DAG",
    "brm_models",
    "Atoll_BU_7_pisc-plank_model.stan"
  ),
  save_pars = save_pars(all = TRUE) # Needed for reloo
)
...
models_list[[10]] <- brm(
  ...
  save_model = here(
    ...
    "DAG",
    "brm_models",
    "Atoll_BU_8_pisc-inv_model.stan"
  ),
  save_pars = save_pars(all = TRUE) # Needed for reloo
)
...
models_list[[12]] <- brm(
  ...
  save_model = here(
    ...
    "DAG",
    "brm_models",
    "Atoll_BU_10_herb-CCA_model.stan"
  ),
  save_pars = save_pars(all = TRUE) # Needed for reloo
)
...
models_list[[13]] <- brm(
  ...
  save_model = here(
    ...
    "DAG",
    "brm_models",
    "Atoll_BU_11_herb-OA_model.stan"
  ),
  save_pars = save_pars(all = TRUE) # Needed for reloo
)
...
dfBUatoll$label <- factor(dfBUatoll$label, levels = rev(dfBUatoll$label))
...
BUatollplot <- ggplot(dfBUatoll, aes(x = effect, y = label, color = group)) +
  geom_point(size = 3) +
